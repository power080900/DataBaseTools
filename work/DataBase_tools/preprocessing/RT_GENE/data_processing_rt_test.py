...
test1 = ["s014", "s015", "s016"]
test2 = ["s001", "s002", "s008", "s010"]
test3 = ["s003", "s004", "s007", "s009"]
test4 = ["s005", "s006", "s011", "s012", "s013"]
...
def ImageProcessing_RT():
    ...
    label_outpath1 = os.path.join(out_root, "labeldata/test", "test1.label")
    label_outpath2 = os.path.join(out_root, "labeldata/test", "test2.label")
    label_outpath3 = os.path.join(out_root, "labeldata/test", "test3.label")
    label_outpath4 = os.path.join(out_root, "labeldata/test", "test4.label")
